...
@section('content')
    <div class="create-book-container">
        <div class="row">
            <div class="header">
                <h2 class="txt-center">Edit a Book item</h2>
            </div>
                ...
                <form action="{{ route('books.update' , $book->id ) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-50">
                            ...
                            <input value="{{ $book->title }}" id="title" name="title" type="text"
                                placeholder="book title ...">
                            <label for="author">
                                author
                            </label>
                            <input type="text" value="{{ $book->author }}" name="author" placeholder="John M. Doe ...">
                            <div class="row">
                                <div class="col-50">
                                    <label for="price">Price</label>
                                    <input value="{{ $book->price }}" type="number" id="price" name="price"
                                        placeholder="000">
                                </div>
                                <div class="col-50">
                                    <label for="old_price">Old price</label>
                                    <input value="{{ $book->old_price }}" type="text" id="old_price" name="old_price"
                                        placeholder="000">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-50">
                            ...
                            <label class="has-offer-container">
                                @if ($book->has_offer)
                                    <input name="has_offer" type="checkbox" checked />
                                @else
                            ...
                            <div class="row">
                                <div class="col-50">
                                    ...
                                    <input type="text" value="{{ $book->year }}" id="year" name="year"
                                        placeholder="0000">
                                </div>
                                <div class="col-50">
                                    <label for="pages">Pages</label>
                                    <input type="text" value="{{ $book->pages }}" id="pages" name="pages"
                                        placeholder="000">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="description-container">
                        ...
                        <textarea style="width: 100%" name="description" rows="10" placeholder="description ...">{{ $book->description }}</textarea>
                    </div>
                    ...
                    <div class="d-center" style="gap: 20px;justify-content: flex-start;">
                        ...
                        <img src="./../../../storage/{{ $book->image }}" id="book-image" class="selected" />
                        <input type="text" value="{{$book->image_id}}" name="image_id" id="book-image-input" hidden />
                    </div>
                    <br>
                    <br>
                    <br>
                    ...
                    <div style="display:flex;gap: 20px;justify-content: flex-start;">
                        ...
                        <div id="sub-images-selected" class="sub-images-selected">
                            {{-- value="map($book->sub_images)" --}}
                            <input type="text"  name="sub_images" id="book-sub-images-input" hidden />

                            @foreach ($book->sub_images as $image)
                                <span>
                                    <p class="btn-close">
                                        <label>&times;</label>
                                    </p>
