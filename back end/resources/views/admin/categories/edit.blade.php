...
@section('content')
    <div class="categories-container">
        ...
        <div id="create-category-container" class="flex-center">
            <form method="POST" action="{{ route('categories.update' , $category->id ) }}" class="create-category-content">
                @csrf
                @method("PUT")
                ...
                <div class="name">
                    ...
                    <input value="{{ $category->name }}" type="text" value="{{ old('category_name') }}"
                ...
                <div class="image">
                    <div>
                        ...
                        value="{{ $category->image_id }}"
                         name="category_image" hidden id="category-image" />
                        <button onclick="showSelectAssetContainer()" type="button" class="btn btn-select">Select</button>
                    </div>
                    <img src="./../../../storage/{{ $category->image }}" id="create-category-image" />
                </div>
                <div class="btns-container">
                    <button type="submit" class="btn btn-update">Save updates</button>
                </div>
            </form>
        </div>
    </div>
